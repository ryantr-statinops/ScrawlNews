...
import { Activity, BarChart3, Bot, RadioTower } from "lucide-react";
  ...
  return (
    <div>
      <Group justify="space-between" align="start" mb="md" gap="md" wrap="wrap">
        <PageHeader title="Insights" description="News trends and model performance" />
      ...
      <Tabs value={tab} onChange={(value) => setTab((value ?? "overview") as AnalyticsTab)} keepMounted={false}>
        <ScrollArea type="auto" mb="md">
          <Tabs.List style={{ flexWrap: "nowrap", minWidth: "max-content" }}>
            ...
            <Tabs.Tab value="content" leftSection={<BarChart3 size={15} />}>News insights</Tabs.Tab>
